...
| Backfill page.type, find untyped pages | `skills/brain-taxonomist/SKILL.md` |
...
| "capture this", "save this thought", "remember this" | `skills/capture/SKILL.md` || "two-tier extraction", "triage then deep read", "smart model routing", "cheap triage expensive analysis" | `skills/two-tier-extraction/SKILL.md` |
...
| "everything in its right place", "eiirp", "organize all of this" | `skills/eiirp/SKILL.md` |
