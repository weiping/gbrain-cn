...
import A_0_assets_index_B5gNvpC1_js from '../admin/dist/assets/index-B5gNvpC1.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CLnyXRh0_css from '../admin/dist/assets/index-CLnyXRh0.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-B5gNvpC1.js": { path: A_0_assets_index_B5gNvpC1_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-CLnyXRh0.css": { path: A_1_assets_index_CLnyXRh0_css as unknown as string, mime: "text/css; charset=utf-8" },
