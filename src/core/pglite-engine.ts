  ...
  async putPage(slug: string, page: PageInput, opts?: { sourceId?: string }): Promise<Page> {
    ...
    const { rows } = await this.db.query(
      `INSERT INTO pages (source_id, slug, type, page_kind, title, compiled_truth, timeline, frontmatter, content_hash, updated_at, effective_date, effective_date_source, import_filename, chinese_search_vector, chunker_version, source_path)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8::jsonb, $9, now(), $10::timestamptz, $11, $12, to_tsvector('simple', $13), COALESCE($14, 1), $15)
      ...
      [sourceId, slug, page.type, pageKind, page.title, page.compiled_truth, page.timeline || '', JSON.stringify(frontmatter), hash, effectiveDate, effectiveDateSource, importFilename, chineseSearchVector, chunkerVersion, sourcePath]
    );
    return rowToPage(rows[0] as Record<string, unknown>);
  }
